...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    TextField3: typeof import('./components/common/inputs/TextField/TextField3.vue')['default']
    TextTestField: typeof import('./components/common/inputs/TextField/TextTestField.vue')['default']
